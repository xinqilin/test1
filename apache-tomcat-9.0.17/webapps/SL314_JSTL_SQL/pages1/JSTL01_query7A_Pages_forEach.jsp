...
<body>
  ...
  <sql:query var="rs" dataSource="${xxx}">
     SELECT EMPNO 員工編號, ENAME 員工姓名, JOB 職位, SAL 薪水, DEPTNO 部門 from emp2 order by EMPNO
  </sql:query>
...
<table border="1">
 ...
 <c:forEach var="row" items="${rs.rowsByIndex}" varStatus="status" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
	<tr>
